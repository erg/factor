...
USING: accessors arrays ascii combinators continuations
destructors f.namespaces fry io io.encodings.utf8 io.files
io.streams.document io.streams.peek io.streams.string kernel
locals make math namespaces sequences strings ;
IN: f.lexer
...
: with-lexer ( lexer quot -- )
    [ drop \ lexer ] 2keep
    '[
        _ [ <document-reader> <peek-stream> ] change-stream
        [
            _
