...
! Integer sequences
TUPLE: iota-wrapper { n integer read-only } ;

: iota ( n -- iota ) \ iota-wrapper boa ; inline

M: iota-wrapper length n>> ; inline
M: iota-wrapper nth-unsafe drop ; inline

INSTANCE: iota-wrapper immutable-sequence
