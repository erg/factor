...
ALIAS: name-analysis ${name}-analysis
ALIAS: name-ins ${name}-ins
ALIAS: name-outs ${name}-outs
ALIAS: name-in ${name}-in
ALIAS: name-out ${name}-out
...
ALIAS: name-ins ${name}-ins
ALIAS: name-outs ${name}-outs
ALIAS: compute-name-sets compute-${name}-sets
